function Container() {
  return (
    <div className="absolute h-[112px] left-0 top-0 w-[694px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#bdbdd6] border-l-[1.992px] border-solid inset-0 pointer-events-none" />
    </div>
  );
}
  ...
  return (
    <div className="h-[27.997px] relative shrink-0 w-[409.557px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Saans:Regular',sans-serif] leading-[1.2] left-0 not-italic text-[#110846] text-[24px] top-[-0.01px] whitespace-nowrap">Rapid Producer Onboarding</p>
      </div>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col h-[111.991px] items-start relative shrink-0 w-full">
      <Container1 />
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="h-[27.997px] relative shrink-0 w-[409.557px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Saans:Regular',sans-serif] leading-[1.2] left-0 not-italic text-[#110846] text-[24px] top-[-0.01px] whitespace-nowrap">Always-On Compliance Monitoring</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[571px]" data-name="Paragraph">
      <p className="absolute font-['Saans:Regular',sans-serif] h-[87px] leading-[1.2] left-[58.01px] not-italic text-[#110846] text-[18px] top-[1.02px] w-[513px]">End the fragmentation. Consolidate producer records, license statuses, appointment details and compliance documentation into one centralized platform that your entire organization can access.</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[144px] items-start relative shrink-0 w-[571px]">
      <Container9 />
      <Paragraph />
    </div>
  );
...
function Container7() {
  return (
    <div className="h-[224px] relative shrink-0 w-full" data-name="Container">
      ...
      <div className="content-stretch flex flex-col items-start pl-[25.985px] relative size-full">
        <Container8 />
      </div>
    </div>
  );
...
function Heading3() {
  return (
    <div className="h-[27.997px] relative shrink-0 w-[409.557px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Saans:Regular',sans-serif] leading-[1.2] left-0 not-italic text-[#110846] text-[24px] top-[-0.01px] whitespace-nowrap">{`Affordable & Scalable`}</p>
      </div>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[738px]">
      <Frame1 />
      <Frame2 />
      <Container7 />
      <Frame6 />
...
function Container13() {
  return (
    <div className="content-stretch flex h-[628px] items-center justify-between relative rounded-[4px] shrink-0 w-[476px]" data-name="Container">
      <Unified />
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="absolute content-stretch flex items-start justify-between left-0 top-0 w-[1280px]">
      <Frame5 />
      <Container13 />
    </div>
  );
...
export default function Component() {
  return (
    <div className="relative size-full" data-name="03">
      <Container />
      <Frame8 />
    </div>
  );
