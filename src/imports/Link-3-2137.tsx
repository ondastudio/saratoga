...
export default function LinkButton() {
  return (
    <Link to="/company/why-saratoga" className="no-underline">
      <div className="group bg-[#af63ff] hover:bg-[#f5f5f5] content-stretch flex gap-[16px] items-center relative rounded-[8px] size-full pl-[24px] pr-[4px] py-[4px] transition-colors duration-200 cursor-pointer" data-name="Link">
