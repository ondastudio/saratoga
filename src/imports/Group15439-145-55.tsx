import svgPaths from "./svg-fyt6ossfw1";

export default function Group() {
  return (
    <div className="relative size-full">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 150.345 39.9989">
        <g clipPath="url(#clip0_145_59)" id="Group 15439">
        ...
        <defs>
          <clipPath id="clip0_145_59">
            <rect fill="white" height="39.9989" width="150.345" />
          </clipPath>
        </defs>
      </svg>
    </div>
