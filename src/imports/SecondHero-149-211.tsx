import svgPaths from "./svg-e4ardz0ear";
...
export default function SecondHero() {
  return (
    <div className="bg-[#300067] content-stretch flex gap-[453px] items-end pb-[64px] px-[80px] relative size-full" data-name="Second-hero">
