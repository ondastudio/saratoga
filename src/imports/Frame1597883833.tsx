import svgPaths from "./svg-rh8z7pu01f";
...
function Frame2() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full">
      <p className="flex-[1_0_0] font-['Saans:Medium',sans-serif] leading-[1.2] min-h-px min-w-px not-italic relative text-[#f5f5f5] text-[28px]">Intuitive Tracking Dashboard</p>
    </div>
  );
}
...
export default function Frame3() {
  return (
    <div className="bg-[#ededed] content-stretch flex gap-[107px] items-start px-[80px] py-[120px] relative size-full">
      ...
      <Frame4 />
      <div className="absolute bottom-[120px] flex h-[296px] items-center justify-center left-[calc(91.67%-48px)] w-[40px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "38" } as React.CSSProperties}>
