...
function Container1() {
  return (
    <div className="absolute content-stretch flex h-[628px] items-center justify-between left-[804px] rounded-[4px] top-[0.48px] w-[476px]" data-name="Container">
      <Unified />
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[27.997px] relative shrink-0 w-[409.557px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Saans:Regular',sans-serif] leading-[1.2] left-0 not-italic text-[#110846] text-[24px] top-[-0.01px] whitespace-nowrap">One Unified Platform for All Producer Data</p>
      </div>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[66px] relative shrink-0 w-[571px]" data-name="Paragraph">
      <p className="absolute font-['Saans:Regular',sans-serif] h-[65px] leading-[1.2] left-[58.02px] not-italic text-[#110846] text-[18px] top-[1.03px] w-[513px]">Whether you manage 50 producers or 5,000, our pricing scales with your business. No hidden fees, no surprise charges – just predictable costs that deliver measurable savings from Day 1.</p>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] h-[122px] items-start relative shrink-0 w-[571px]">
      <Container13 />
      <Paragraph />
    </div>
  );
