import svgPaths from "./svg-33n4eclnf3";

const marqueeStyles = `
@keyframes marquee-right-home {
  0% { transform: translateX(-50%); }
  100% { transform: translateX(0%); }
}
@keyframes marquee-left-home {
...
function Frame4() {
  return (
    <div className="content-stretch flex items-start pb-[40px] relative shrink-0 w-full">
      ...
      <p className="font-['Px_Grotesk:Regular',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[#af63ff] text-[14px] uppercase w-[350px]">{`Trusted By The Most Innovative & Efficient Insurance Agents, Carriers & MGAs`}</p>
    </div>
  );
}
  ...
  return (
    <div className="overflow-hidden relative shrink-0 w-full">
      <div
        ...
        style={{ animation: "marquee-right-home 30s linear infinite" }}
      >
  ...
  return (
    <div className="overflow-hidden relative shrink-0 w-full">
      <div
        ...
        style={{ animation: "marquee-left-home 30s linear infinite" }}
      >
...
export default function SecondHero() {
  return (
    <div className="bg-[#300067] content-stretch flex flex-col items-start pb-[120px] pt-[64px] px-[80px] relative size-full" data-name="Second-hero">
